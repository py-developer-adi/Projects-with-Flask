...
@server.route('/edit/<contact>')
def edit(contact):
    query = Contact.query.filter_by(id=contact).first()
    return render_template('edit.html', contact=query)

@server.route('/edit-contact', methods=['GET', 'POST'])
def save():
